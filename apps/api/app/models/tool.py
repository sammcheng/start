...
class Tool(Base):
    ...
    input_type: Mapped[InputType] = mapped_column(Enum(InputType, name="inputtype"))
    output_type: Mapped[OutputType] = mapped_column(Enum(OutputType, name="outputtype"))
    input_schema: Mapped[dict | None] = mapped_column(JSON, nullable=True)
    output_schema: Mapped[dict | None] = mapped_column(JSON, nullable=True)
    price_per_request: Mapped[Decimal] = mapped_column(Numeric(10, 6))
